...
function ss.MakeBlasterExplosion(ink)
    ...
    ss.SetEffectFlags(e, dropdata.Weapon, ss.INK_EFFECT_TYPE.SHOOTER, 16)
    ss.SetEffectInitPos(e, dropdata.InitPos)
    ss.SetEffectInitDir(e, dropdata.InitVel:GetNormalized())
    ss.SetEffectInitSpeed(e, dropdata.InitVel:Length())
