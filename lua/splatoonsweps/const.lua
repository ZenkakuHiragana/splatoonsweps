...
ss.VoiceSuffix = {
    [ss.PLAYER.GIRL]     = "SquidFemale",
    [ss.PLAYER.BOY]      = "SquidMale",
    [ss.PLAYER.MARIE]    = "SquidFemale",
    [ss.PLAYER.CALLIE]   = "SquidFemale",
    [ss.PLAYER.OCTO]     = "OctoFemale",
    [ss.PLAYER.OCTOGIRL] = "OctoFemale",
    [ss.PLAYER.OCTOBOY]  = "OctoMale",
    [ss.PLAYER.PEARL]    = "SquidFemale",
    [ss.PLAYER.MARINA]   = "OctoFemale",
}
ss.ChargingEyeSkin = {
    [Marie]   = 0,
    [Callie]  = 5,
...
ss.Particles = {
    ...
    KillerWail           = "splatoonsweps_killerwail_sonic",
    KillerWailEnd        = "splatoonsweps_killerwail_end",
    MarkerLeft           = "splatoonsweps_marker_off_%s%d",
    MarkerSquare         = "splatoonsweps_pointsensor_square",
...
ss.PointSensorDuration      = 8                           -- It was 10 sec. before version 2.1.0.
ss.EcholocatorDuration      = 9                           -- It was 12 sec. before version 2.7.0.
